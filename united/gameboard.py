...
from united.ui.regionframe import RegionFrame
from united.ui.playframe import PlayFrame
...
class GameBoard:
    ...
    def __init__(self, rootFrame):
        ...
        self.regionPage = RegionFrame(rootFrame, self)
        self.playPage = PlayFrame(rootFrame, self)
        self.rootPage = {"start_page":self.startPage,
                         "region_page":self.regionPage,
                         "play_page":self.playPage} # 分頁
    ...
    def checkAccountLogin(self):
        if True == self.loginPlayer.hasPlayerUUID(): #已登入
