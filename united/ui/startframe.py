...
"""
from tkinter import Frame,Button,Grid,Label,Canvas,font
...
class StartFrame:
    ...
    def __init__(self, master, gameboard):
        ...
        self.startBtn = Button(self.frame, font=font.Font(size=24), text="開始遊戲", state= "disable", command=self.switchToRegionPage)
