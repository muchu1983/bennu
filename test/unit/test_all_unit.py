...
from test.unit.test_staticmap import StaticMapTest
"""
執行所有單元測試
"""
...
suite_of_staticmap = unittest.TestLoader().loadTestsFromTestCase(StaticMapTest)
...
suite_of_all_unit.addTest(suite_of_staticmap)
